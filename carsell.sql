...
insert  into `client`(`clientid`,`clientname`,`clientsex`,`clientage`,`clientphone`,`clientmail`,`engineid`) values (15,'杨某','男',22,'13111111111','nicejava@163.com',5312715);
...
insert  into `employee`(`userid`,`username`,`password`,`sex`,`age`,`loginname`,`department`) values (1,'管理员','admin','男',22,'admin','经理'),(21,'维修人员','wx','男',30,'wx','维修'),(22,'销售人员','xs','女',20,'xs','销售');
...
insert  into `sell`(`engineid`,`selldate`,`carid`,`userid`) values (3445533,'2013-01-01',2,22),(5312715,'2013-01-01',1,22);
...
insert  into `service`(`serid`,`serdate`,`serstate`,`clientid`) values (3,'2012-12-29','完成',NULL);
