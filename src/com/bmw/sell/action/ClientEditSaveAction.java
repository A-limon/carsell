...
/**
 * Servlet implementation class ClientEditSaveAction
 */
@WebServlet("/client/editsave.do")
public class ClientEditSaveAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ClientEditSaveAction() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			ic.modify(clientid, clientname, clientsex, clientage, clientphone, clientmail, engineid);
