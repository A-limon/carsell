...
/**
 * Servlet implementation class ClientMailAction
 */
@WebServlet("/client/mail.do")
public class ClientMailAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ClientMailAction() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			javax.servlet.RequestDispatcher rd=request.getRequestDispatcher("../index/mail.do");
