...
<div class="container-fluid" id="main">
  <div class="row-fluid">
    ...
    <div class="span10"> 
		 <h2>添加新员工</h2>
<form class="form-horizontal" action="${path}/employee/add.do" method="post">
  <div class="control-group">
    <label class="control-label" for="inputusername">姓名</label>
    <div class="controls">
      <input type="text" id="inputusername" name="inputusername" maxlength="8" required placeholder="员工姓名">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="inputloginname">登录名</label>
    <div class="controls">
      <input type="text" id="inputloginname" maxlength="16" name="inputloginname" required placeholder="员工登录名">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="inputPassword">密码</label>
    <div class="controls">
      <input type="password" id="inputPassword" maxlength="16" name="inputPassword" placeholder="登录密码" required>
    </div>
  </div>
  <div class="control-group">
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input type="number" name="inputage"  min="18" max="55" id="inputage" required placeholder="员工年龄">
    </div>
  </div>
  <div class="control-group">
